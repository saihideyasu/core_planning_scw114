...
private:
  ...
  ros::Publisher safety_waypoints_pub_, no_curve_waypoints_pub_, back_waypoint_pub_, tmp_pub_;
  ...
  ros::Subscriber avoidance_lane_info_list_sub_;
  ros::Rate *rate_;
  ...
  autoware_msgs::AvoidanceLaneInfoList avoidance_lane_info_list_;
  ...
  void avoidanceLaneInfoCallback(const autoware_msgs::AvoidanceLaneInfoList& msg);
