  ...
  if (vs_info.getDecelerationRange() < 0.01)
  {
    ...
    else if(ob_type & (int)EObstacleType::ON_MOBILEYE)
    {
        ...
        else
        {
          ...
          if(mobileye_posx > vehicle_vel * 3.6 / 2 + posx_offset)
          {
...
int main(int argc, char** argv)
{
  ...
  ros::Subscriber config_sub = nh.subscribe("config/velocity_set111scw", 1, &VelocitySetInfo::configCallback, &vs_info);
